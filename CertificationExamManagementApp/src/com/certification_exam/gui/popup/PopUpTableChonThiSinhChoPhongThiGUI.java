 ...
 * @author Hi
 */
public class PopUpTableChonThiSinhChoPhongThiGUI extends javax.swing.JFrame {
    ...
    String[] columnNames = {
                            ...
                            "Họ",
                            "Tên"};
    public PopUpTableChonThiSinhChoPhongThiGUI() {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnThem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/certification_exam/gui/popup/save_icon.png"))); // NOI18N
        ...
        btnXoa.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/certification_exam/gui/popup/save_icon.png"))); // NOI18N
        btnXoa.setText("Xóa");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopUpTableChonThiSinhChoPhongThiGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PopUpTableChonThiSinhChoPhongThiGUI().setVisible(true);
            }
        });
    }
