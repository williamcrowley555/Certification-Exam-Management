...
public class PopUpTableChonKhoaThiGUI extends javax.swing.JFrame {
    ...
    public PopUpTableChonKhoaThiGUI(Long examine_id, int month, int year) {
        initComponents();
        ...
        setComboBox(comboBoxTrinhDo, getEnglishLevelItems());
    ...
    {      
        String selectedLevel = comboBoxTrinhDo.getSelectedItem().toString();
        Long idLevel = Long.parseLong(selectedLevel.substring(0, selectedLevel.indexOf(" - ")));
        System.out.println(idLevel);
        tblKhoaThi.setModel(new KhoaThiTableLoaderUtil().setTable(examCourseBLL.findByEnglishLevelIdAndMonthAndYearStartOn(idLevel,this.month, this.year), columnNames));
        headerColor(14,142,233,tblKhoaThi);
    }
   ...
   public String[] getEnglishLevelItems() {
        List<EnglishLevel> englishLevelLists = englishLevelBLL.findAll();
        String[] englishLevelItems = new String[englishLevelLists.size()];
        int index = 0;
        for(EnglishLevel vt : englishLevelLists) {
            englishLevelItems[index] = vt.getId() + " - " + vt.getName();
            ++ index;
        }
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(comboBoxTrinhDo, javax.swing.GroupLayout.PREFERRED_SIZE, 104, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void btnLuuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLuuActionPerformed
        IExamCourseExamineBLL examCourseExamineBLL = new ExamCourseExamineBLL();
        
        int rowindex = tblKhoaThi.getSelectedRow();
        if (rowindex >= 0) 
        {
        Long id = Long.parseLong(tblKhoaThi.getValueAt(rowindex,0).toString());
        ExamCourseExamine examCourseExamine = new ExamCourseExamine(id, this.examine_id);
        ExamCourseExamine duplicateRegisterCourse = examCourseExamineBLL.findByExamCourseIdAndExamineId(id, this.examine_id);
            if (duplicateRegisterCourse == null)
            {
                examCourseExamineBLL.save(examCourseExamine);
                JOptionPane.showMessageDialog(this, "Đã lưu thành công", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
                this.dispose();
            } else  JOptionPane.showMessageDialog(this, "Thí sinh đã đăng ký khóa này", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
       // popUpDoan.setGiaTour(giaTourBLL.findById(id));       
        
        } else JOptionPane.showMessageDialog(this, "Vui lòng chọn khóa để đăng ký", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
