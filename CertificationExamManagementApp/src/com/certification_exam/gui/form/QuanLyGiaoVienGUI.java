 ...
 * @author RavenPC
 */
public class QuanLyGiaoVienGUI extends javax.swing.JPanel {
    ...
    private PopUpGiaoVienGUI popUp = null;
    TableRowSorter<TableModel> rowSorter = null;
    
    public QuanLyGiaoVienGUI() {
        initComponents();
        // Ghi chu
        ...
        headerColor(14,142,233,tblGiaoVien);
        scroll.getVerticalScrollBar().setUI(new MyScrollBarUI());
    }
    
    public void loadTableData() {
        tblGiaoVien.setModel(new NhanVienTableLoaderUtil().setTable(nhanVienBLL.findByStatus(true), this.listColumns)) ;
        this.rowSorter = TableSetupUtil.setTableFilter(tblGiaoVien, txtTimKiem);
        headerColor(14,142,233,tblGiaoVien);
    }
    ...
    private void initComponents() {
        ...
        itemXoa.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/certification_exam/img/delete_icon.png"))); // NOI18N
        itemXoa.setText("Xóa");
        ...
        tblGiaoVien.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                tblGiaoVienMouseReleased(evt);
            }
        });
        scroll.setViewportView(tblGiaoVien);
    ...
    private void btnThemMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnThemMousePressed
        if (this.popUp == null) {
            this.popUp = new PopUpGiaoVienGUI("POST");
    ...
    private void itemSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_itemSuaActionPerformed
        int rowindex = tblGiaoVien.getSelectedRow();
        Long id = Long.parseLong(tblGiaoVien.getValueAt(rowindex,0).toString());
        if (this.popUp == null) {
        popUp = new PopUpGiaoVienGUI("PUT", nhanVienBLL.findById(id));
        } else {
            this.popUp.toFront();
            this.popUp.center();
        }
    ...
    private void tblGiaoVienMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblGiaoVienMouseReleased
        // TODO add your handling code here:
        int r = tblGiaoVien.rowAtPoint(evt.getPoint());
        if (r >= 0 && r < tblGiaoVien.getRowCount()) {
            tblGiaoVien.setRowSelectionInterval(r, r);
        } else {
    ...
    }//GEN-LAST:event_tblGiaoVienMouseReleased
