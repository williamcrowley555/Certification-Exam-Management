 ...
 * @author Hi
 */
public class PopUpGiaoVienGUI extends javax.swing.JFrame {
    ...
    public PopUpGiaoVienGUI(String action) {
        initComponents();
    ...
    public PopUpGiaoVienGUI(String action, NhanVienDTO nhanVien) {
        initComponents();
        this.action = action;  
    ...
    public void setLabelText(NhanVienDTO nhanVien)
    {
        ...
        txtEmail.setText(nhanVien.getDiaChi());
    ...
    {   
        ...
        if (InputValidatorUtil.isValidAddress(txtEmail.getText()).isEmpty())  
        {
           DiaChi = true;
           ...
           lblValidateDiaChi.setToolTipText(InputValidatorUtil.isValidAddress(txtEmail.getText()));
        }
    ...
    private NhanVienDTO getFormInfo() throws IOException {
        ...
        nhanVien.setDiaChi(txtEmail.getText().trim());
        ...
        pnlBodyLayout.setHorizontalGroup(
            ...
            .addGroup(pnlBodyLayout.createSequentialGroup()
                ...
                .addGroup(pnlBodyLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(DCNgaySinh, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 214, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnLuuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLuuActionPerformed
        if (validateForm())
        {
            ...
            try {
                ...
                Logger.getLogger(PopUpGiaoVienGUI.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopUpGiaoVienGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PopUpGiaoVienGUI().setVisible(true);
            }
        });
    }
