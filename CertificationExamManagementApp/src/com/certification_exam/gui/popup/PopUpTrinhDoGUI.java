 ...
 * @author Hi
 */
public class PopUpTrinhDoGUI extends javax.swing.JFrame {
    private String action;
    private ILoaiDuLichBLL loaiDuLichBLL;
    private LoaiDuLichDTO loaiDuLich;
   
    public PopUpTrinhDoGUI(String action) {
        initComponents();      
        this.action = action;
    ...
    public PopUpTrinhDoGUI(String action, LoaiDuLichDTO  loaiDuLich) {
        initComponents();
        this.action = action;
    ...
    private void initComponents() {
        ...
        lblTenVaiTro.setText("Tên Trình Độ:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopUpTrinhDoGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PopUpTrinhDoGUI().setVisible(true);
            }
        });
    }
